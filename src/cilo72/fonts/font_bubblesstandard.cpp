...
#include <stdint.h>
#include "cilo72/fonts/font_bubblesstandard.h"
...
namespace cilo72
{
    namespace fonts
    {
        namespace
        {
           ...
           * <data>
           */
            constexpr uint8_t bubblesstandard_font[] = {
            	8, 7, 0, 32, 126,
            ...
            uint8_t FontBubblesstandard::height() const
            {
                return bubblesstandard_font[0];
            }

            uint8_t FontBubblesstandard::width() const
            {
                return bubblesstandard_font[1];
            }

            uint8_t FontBubblesstandard::spacingPerChar() const
            {
                return bubblesstandard_font[2];
            }

            uint8_t FontBubblesstandard::firstAscciiChar() const
            {
                return bubblesstandard_font[3];
            }

            uint8_t FontBubblesstandard::lastAscciiChar() const
            {
                return bubblesstandard_font[4];
            }

            const uint8_t * FontBubblesstandard::data() const
            {
                return bubblesstandard_font + 5;
            }
    }
}
