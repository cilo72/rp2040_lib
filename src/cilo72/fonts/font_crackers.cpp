...
#include <stdint.h>
#include "cilo72/fonts/font_crackers.h"
...
namespace cilo72
{
    namespace fonts
    {
        namespace
        {
           ...
           * <data>
           */
           constexpr unsigned char crackers_font[] = {
           	8, 6, 2, 32, 126,
            ...
            uint8_t FontCrackers::height() const
            {
                return crackers_font[0];
            }

            uint8_t FontCrackers::width() const
            {
                return crackers_font[1];
            }

            uint8_t FontCrackers::spacingPerChar() const
            {
                return crackers_font[2];
            }

            uint8_t FontCrackers::firstAscciiChar() const
            {
                return crackers_font[3];
            }

            uint8_t FontCrackers::lastAscciiChar() const
            {
                return crackers_font[4];
            }

            const uint8_t * FontCrackers::data() const
            {
                return crackers_font + 5;
            }
    }
}
