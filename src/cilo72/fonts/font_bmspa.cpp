...
#include <stdint.h>
#include "cilo72/fonts/font_bmspa.h"
    ...
    namespace fonts
    {
        namespace
        {
           ...
           */
            ...
            uint8_t FontBMSPA::height() const
            {
                return BMSPA_font[0];
            }

            uint8_t FontBMSPA::width() const
            {
                return BMSPA_font[1];
            }

            uint8_t FontBMSPA::spacingPerChar() const
            {
                return BMSPA_font[2];
            }

            uint8_t FontBMSPA::firstAscciiChar() const
            {
                return BMSPA_font[3];
            }

            uint8_t FontBMSPA::lastAscciiChar() const
            {
                return BMSPA_font[4];
            }

            const uint8_t * FontBMSPA::data() const
            {
                return BMSPA_font + 5;
            }
    }
