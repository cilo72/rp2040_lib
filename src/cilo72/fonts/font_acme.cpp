...
#include <stdint.h>
#include "cilo72/fonts/font_acme.h"
...
const uint8_t acme_font[] = {
	...
	0x00,0x00,0x00,0x00,0x00,0x00
            ...
            uint8_t FontAcme::height() const
            {
                return acme_font[0];
            }

            uint8_t FontAcme::width() const
            {
                return acme_font[1];
            }

            uint8_t FontAcme::spacingPerChar() const
            {
                return acme_font[2];
            }

            uint8_t FontAcme::firstAscciiChar() const
            {
                return acme_font[3];
            }

            uint8_t FontAcme::lastAscciiChar() const
            {
                return acme_font[4];
            }

            const uint8_t * FontAcme::data() const
            {
                return acme_font + 5;
            }
    }
